    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Admin Access Pending</h2>
          <p className="text-gray-600 mb-4">
            Your admin access request is under review. You will be notified when approved.
          </p>
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-400">
              User: {user?.email} | Status: Pending Approval
            </p>
          </div>
        </div>
      </div>
